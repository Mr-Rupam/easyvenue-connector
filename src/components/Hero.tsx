...
const Hero = () => {
  return (
    <div className="relative bg-gradient-to-r from-bookeasy-navy to-[#1E0D73] py-20 md:py-28">
          ...
          <div className="bg-white rounded-lg p-4 shadow-lg max-w-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center space-x-2 bg-gray-50 px-3 py-2 rounded-md">
                <MapPin size={18} className="text-[#1E0D73]" />
                <input 
                  type="text" 
              ...
              <div className="flex items-center space-x-2 bg-gray-50 px-3 py-2 rounded-md">
                <Calendar size={18} className="text-[#1E0D73]" />
                <input 
                  type="text" 
                  placeholder="Date" 
                  className="bg-transparent w-full outline-none border-none text-sm"
