...
const Signup = () => {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    // This is where you'd handle actual signup logic with a backend
    // For now, we'll just show a success message and redirect
    if (fullName && email && password && agreeTerms) {
      toast({
        title: "Account created successfully",
        description: "Welcome to BookEasy! You can now log in.",
      });
      navigate("/login");
    } else {
      toast({
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-lg border border-bookeasy-lightgray p-8">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold text-bookeasy-navy">Create an Account</h1>
              <p className="text-muted-foreground mt-2">Join BookEasy to start booking spaces</p>
            </div>
